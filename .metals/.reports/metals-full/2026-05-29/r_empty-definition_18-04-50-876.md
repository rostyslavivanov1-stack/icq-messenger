error id: file:///D:/Java%20ICQ%20Project/icq-messenger/src/main/java/ua/knure/icq/server/ServerApp.java:java/lang/System#out.
    ...
    public static void main(String[] args){
        ...
        try (ServerSocket serverSocket = bindServerSocket(PORT)) {
            ...
            try (){
                ...
                System.ou@@t.println("Server accepted client connection.");
