error id: file:///D:/Java%20ICQ%20Project/icq-messenger/src/main/java/ua/knure/icq/server/ServerApp.java:java/io/PrintStream#println(+7).
...
public class ServerApp {
    ...
    private static void handleClient(Socket clientSocket) throws IOException {
        ...
        while (message != null) {
            System.out.prin@@tln("Client: " + message);
